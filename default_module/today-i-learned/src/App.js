...
function NewFactForm({ setFacts, setShowForm }) {
  ...
  return (
    <form className="fact-form" onSubmit={handleSubmit}>
      <input type="text" placeholder="Share a fact with the world..." name="" id="" value={text} onChange={(e) => setText(e.target.value)} />
      <span id="maximumTextInput">{200 - textLength}</span>
      <input type="text" placeholder="Trustworthy source..." name="" id="" value={source} onChange={(e) => setSource(e.target.value)} />
